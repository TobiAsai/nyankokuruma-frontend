  ...
  const menuList: menuInfo[] = [
    {
      ...
      haveSecondary: true,
      secondaryNav: [
        { info: "🐈PVC現貨", infoId: Math.random(), url: "/" },
        { info: "🐈海外代購現貨", infoId: Math.random(), url: "/" },
        { info: "🐈PVC預購", infoId: Math.random(), url: "/" },
        { info: "🐈吉伊卡哇", infoId: Math.random(), url: "/" },
        { info: "🐈貓車福箱", infoId: Math.random(), url: "/" },
        { info: "🐈GK現貨", infoId: Math.random(), url: "/" },
        { info: "🐈貓車周年慶", infoId: Math.random(), url: "/" },
      ],
    },
    {
      mainInfo: "商品標籤",
      ...
      haveSecondary: true,
      secondaryNav: [
        { info: "Hololive", infoId: Math.random(), url: "/" },
        { info: "Nijisanji彩虹社", infoId: Math.random(), url: "/" },
        { info: "香香妹子", infoId: Math.random(), url: "/" },
        { info: "Lycoris 莉可麗絲", infoId: Math.random(), url: "/" },
        { info: "OVERLORD", infoId: Math.random(), url: "/" },
        { info: "火影忍者", infoId: Math.random(), url: "/" },
        { info: "初音未來miku", infoId: Math.random(), url: "/" },
        { info: "🐈福箱專區", infoId: Math.random(), url: "/" },
        { info: "米哈遊", infoId: Math.random(), url: "/" },
      ],
    },
  ];
